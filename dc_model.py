# -*- coding: utf-8 -*-
"""
Created on Sun Aug 16 23:53:56 2020
...
def dc_model(t_outdoor):
    ...
    # %% Build a DataFrame
    serie_name = t_outdoor.name
    t_outdoor.name = 't_outdoor'
    
    # Add the workload profile repeated 365 times
    dc_df = pd.DataFrame(t_outdoor).assign(it_load=(workload_profile * 365))
    #
    dc_df = dc_df.assign(
    ...
    df_times.columns = serie_name + '_' + df_times.columns
